...
% load '/Users/jveatch/Documents/MATLAB/SWARM/scales/CODAR_tide_filled.mat'
...
k = 1;
%%
for i=datetime('28-Feb-2020 00:00:00'):hours(1):datetime('07-Mar-2020 00:00:00')
    date_str = datestr(i);
    T_0 = find(CODAR_filled.dnum == datenum(date_str));
    T_1 = T_0+7; %% CHANGE INTEGRATION TIME HERE
...
save('ftle_all_feb28mar7_HR_6_tides' , 'ftle_all');

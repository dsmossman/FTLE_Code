...
resolution = [resolutionY,resolutionX];
...
print(fullfile('/home/jmv208/LCS-Tool-master/demo/ocean_dataset', 'MAB_ftle_correctInversion.png'), '-dpng', '-r300');
ftle_mab.domain = domain;
ftle_mab.resolution = resolution;
ftle_mab.ftle = ftle_;

save('mab_ftle_test_correctInversion' , 'ftle_mab');

...
load('MARACOOS_filled_zeroes.mat');

vLat = MARACOOS_filled.V; 
...
date_str = '05-July-2022 00:00:00';
T_0 = find(MARACOOS_filled.dnum == datenum(date_str));
T_1 = T_0+23;

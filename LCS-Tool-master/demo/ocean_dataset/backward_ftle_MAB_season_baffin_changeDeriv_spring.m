...
load('C:/Users/dmossman/Box/FTLE Work/Processed Data/Gapfilled Data/MARACOOS_spring_deployment_2023_filled.mat');
...
grd_file = 'C:/Users/dmossman/Box/FTLE Work/Jackie Code/LCS-Tool-master/demo/ocean_dataset/GMRTv4_2_20240326topo.grd';
...
for i=datetime(min(dnum), 'ConvertFrom', 'datenum'):days(1):(datetime(max(dnum), 'ConvertFrom', 'datenum')-days(1))
...
fname = strcat('C:\Users\dmossman\Box\FTLE Work\Processed Data\Glider Deployment Data\','MARACOOS_spring_deployment_2023_filled.mat');

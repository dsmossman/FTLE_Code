...
% hEllipticLcs = copyobj(hEllipticLcs,hAxes); %%%%%% a piece from closedLambda
% drawnow % a piece from closedLambda
...
% for i = 1:nPoincareSection %%%%%% a piece from closedLambda, commented out to see if it would still worl

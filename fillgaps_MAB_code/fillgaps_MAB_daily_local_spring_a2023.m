...
clear variables; close all; addpath(genpath('C:/Users/dmossman/Box/FTLE Work/'))

% ncFile = '/Users/jveatch/Documents/Python/MAB/maracoos_5MHz_6km_totals_2023_secondHalf.nc';
ncFile = 'realtime_maracoos_6km_totals_qartod_04-20_to_05-12_2023.nc';
...
MARACOOS.dnum = convertTo(MARACOOS.dt,'datenum');
dnum = MARACOOS.dnum;
u = MARACOOS.u;
v = MARACOOS.v;
...
%%
fname = strcat('C:\Users\dmossman\Box\FTLE Work\Processed Data\Gapfilled Data\','MARACOOS_spring_deployment_2023_filled.mat');

save(fname,"MARACOOS_filled")
